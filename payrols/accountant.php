  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <?php
        echo "<li ";
        if (!isset($_GET['Part'])|| $_GET['Part']=='home2' ){echo "class='active'";} 
        echo"><a href='accountant.php?Part=home2'>Accountant Module</a></li>";

        ?>
    
        <li><a data-toggle="modal" href="#payment">Process Payment</a></li>

      <?php
        echo "<li ";
        if (!isset($_GET['Part'])|| $_GET['Part']=='home2' ){echo "class='active'";} 
        echo"><a href='accountant.php?Part=loan'>Loan Module</a></li>";
...
<!-- this modal is for processing payment -->
      <div class="modal fade" id="payment" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header" style="padding:20px 50px;">
              <button type="button" class="close" data-dismiss="modal" title="Close">&times;</button>
              <h3 align="center"><b>Process Salary Payment</b></h3>
            </div>
            <div class="modal-body" style="padding:40px 50px;">

              <form class="form-horizontal" action="accountant.php?Part=payment"  method="post">
              <div class="form-group">
                
                  <label class="col-sm-4 control-label">Payment Due:</label>
                  <div class="col-sm-8">
                    <select name="mnth" class="form-control" placeholder="Level" required>
        ...
        case "12":
            ...
            echo"<option values='$premonth'".">".$premonth."</option>";          
       ?>               
                     </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="reset" name="" class="btn btn-danger" value="Cancel">
                  </div>
                </div>
              </form>
            </div>
